 ...
 *
 */
void ImageLoader::loadCreator(QObject* dataObject)
{
    ...
    // DiCoTAE redirects Creator Images to https://
    // to avoid ssl errors:
        ...
        if (reply->error() == QNetworkReply::NoError) {
            ...
            if (available > 0) {
                ...
                if(httpStatusCode == 200) {
                    ...
                    // using a QImage because downloaded creator images can have different dpi - so we adjust this here-
