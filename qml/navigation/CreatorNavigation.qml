...
Page {
    ...
    property string name: "CreatorNavPage"
    ...
    StackView {
        id: navPane
        anchors.fill: parent
        property string name: "CreatorNavPane"
        focus: true

        initialItem: CreatorListPage{
            id: initialItem
        }
    ...
    function sectionPickerClosed() {
        if(sectionPickerLoader.item.isOK) {
            initialItem.goToItemIndex(dataUtil.findFirstCreatorItem(sectionPickerLoader.item.selectedSection))
        }
    }
    Connections {
    ...
    function init() {
        console.log("INIT CreatorNavPane")
        initialItem.init()
    }
    function cleanup() {
        console.log("Cleanup CreatorNavPane")
    }
