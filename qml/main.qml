...
// This app demonstrates HowTo use Qt 5.9.x new Qt Quick Controls 2, High DPI and more
// This app's goal is only to help you to understand some concepts
// see blog http://j.mp/qt-x to learn about Qt 5.9.x for Material - styled Android or iOS Apps
...
ApplicationWindow {
    ...
    //modality: Qt.NonModal (the default), Qt.WindowModal, and Qt.ApplicationModal.
    ...
    // Variable de control para habilitar el botón de actualizaciones
    property bool enableVersionCheck: false
    // Variable de control para habilitar las actualizaciones automáticas
    property bool autoVersionCheck: false
    ...
    property bool myDictionaryActive: false
    onMyDictionaryActiveChanged: {
        if(myDictionaryActive) {
            //navigationModel[2].icon = "dictionary_my.png"
            drawerLoader.item.replaceIcon(dictionaryNavigationIndex,"stars.png")
            drawerLoader.item.replaceText(dictionaryNavigationIndex,qsTr("My Dictionary"))
            favoritesLoader.item.replaceIcon(dictionaryFavoritesIndex,"stars.png")
            favoritesLoader.item.replaceText(dictionaryFavoritesIndex,qsTr("My Dictionary"))
        } else {
            //navigationModel[2].icon = "dictionary.png"
            drawerLoader.item.replaceIcon(dictionaryNavigationIndex,"dictionary.png")
            drawerLoader.item.replaceText(dictionaryNavigationIndex,qsTr("Dictionary"))
            favoritesLoader.item.replaceIcon(dictionaryFavoritesIndex,"dictionary.png")
            favoritesLoader.item.replaceText(dictionaryFavoritesIndex,qsTr("Dictionary"))
        }
    }
    ...
    property int fontSizeDisplay0: 26
    ...
    property int fontSizeActiveNavigationButton: 12
    property int fontSizeInactiveNavigationButton: 10
    ...
    property int dictionaryNavigationIndex: 2
    property int creatorNavigationIndex: 3
    property int tagsNavigationIndex: 4
    property int contentBlocksNavigationIndex: 5
    property int contentStandardTypesNavigationIndex: 6
    //property int venueNavigationIndex: 7
    //property int sectionsNavigationIndex: 8
    property int settingsNavigationIndex: 8
    property int helpNavigationIndex: 9
    property int aboutNavigationIndex: 10
    property var navigationModel: [
        {"type": "../navigation/DrawerNavigationButton.qml", "name": "DiCoTAE", "icon": "home.png", "source": "../pages/HomePage.qml", "showCounter":false, "showMarker":false, "a_p":1, "canGoBack":false},
        {"type": "../navigation/DrawerDivider.qml", "name": "", "icon": "", "tag": "", "a_p":1, "canGoBack":false, "source":""},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Dictionary"), "icon": "dictionary.png", "source": "../navigation/DictionaryNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Creators"), "icon": "creator.png", "source": "../navigation/CreatorNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Tags"), "icon": "tag.png", "source": "../navigation/TagNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("ContentBlocks"), "icon": "folder.png", "source": "../navigation/ContentBlockNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("ContentStandardTypes"), "icon": "folder_fav.png", "source": "../navigation/ContentStandardTypeNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        ...
        //{"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Sections"), "icon": "directions.png", "source": "../navigation/SectionsNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerDivider.qml", "name": "", "icon": "", "tag": "", "a_p":1, "canGoBack":false, "source":""},
        ...
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("About this App"), "icon": "info.png", "source": "../pages/AboutPage.qml", "showCounter":false, "showMarker":false, "a_p":3, "canGoBack":false}
    ]
    property var developerModel: {
        "type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("DEVELOPER Tools"), "icon": "code.png", "source": "../pages/DevToolsPage.qml", "showCounter":false, "showMarker":false, "a_p":3, "canGoBack":false
    }
    ...
    property var navigationTitles: [
        qsTr("DiCoTAE"),
        "",
        qsTr("DiCoTAE - Dictionary"),
        qsTr("DiCoTAE - Creators"),
        qsTr("DiCoTAE - Tags"),
        qsTr("DiCoTAE - ContentBlocks"),
        qsTr("DiCoTAE - ContentStandardTypes"),
        //qsTr("DiCoTAE - Venue"),
        //qsTr("DiCoTAE - Sections"),
        "",
        qsTr("DiCoTAE - Settings"),
        qsTr("DiCoTAE - Help"),
        qsTr("DiCoTAE - About"),
        qsTr("DiCoTAE - DEVELOPER Tools")
    ]
    ...
    property int dictionaryFavoritesIndex: 1
    property int creatorFavoritesIndex: 2
    property int tagsFavoritesIndex: 3
    property var favoritesModel: [
        homeNavigationIndex, dictionaryNavigationIndex, contentStandardTypesNavigationIndex, tagsNavigationIndex
    ]
    ...
    property bool startWithSearch: false
    property bool fullTextSearch: false
    ...
    StackView {
        ...
        Timer {
            ...
            onTriggered: {
                ...
                destinations.model = []
                // start update dictionary (C++)
                dataUtil.startUpdate()
            }
        } // updateTimer

        function startUpdate() {
            myDictionaryActive = false
        ...
        Timer {
            ...
            onTriggered: {
                ...
                dataUtil.setKeyFavorites()
                dataManager.resolveReferencesForAllCreator()
                dataManager.resolveReferencesForAllKey()
                dataUtil.resolveKeysForDictionary()
                ...
                if(myApp.isDebugBuild() && !initialPlaceholder.isUpdate) {
                    ...
                    // TODO: Para habilitar el debugger
                ...
                if(dataUtil.isDateTooLate()) {
                    // no version checks anymore - repository closed
                    return
                }
        ...
        // as long as repository is ended
        Timer {
        ...
        function replaceDestination(theItemLoader) {
            ...
            if(rootPane.currentItem.name == "DictionaryNavPage") {
            ...
            if(theItemLoader.item.name == "DictionaryNavPage") {
