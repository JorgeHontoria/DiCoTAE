...
Page {
    ...
    function goToPage(thePageIndex) {
        navSwipePane.goToPage(thePageIndex)
    }
    ...
    Loader {
        ...
        visible: !isLandscape
        active: !isLandscape
        source: "../tabs/DictionaryTabBar.qml"
        onLoaded: {
    ...
    SwipeView {
        ...
        function applyFilterExpression(filterexpression, startWith, fullTextSearch) {
            if (filterexpression !== "" ){
                dataUtil.resolveKeysForDictionaryByFilter(filterexpression, startWith, fullTextSearch)
                navPane.goToSearchResult()
            }
        }
