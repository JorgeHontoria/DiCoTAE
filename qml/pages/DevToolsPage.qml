...
Flickable {
    ...
    Pane {
        ...
        ColumnLayout {
                    ...
                    Switch {
                        ...
                        onCheckedChanged: {
                            ...
                            if(root.settingsData.publicRoot4Dev.length == 0) {
                                root.settingsData.publicRoot4Dev = "/data/msolanogadea/"+Qt.application.name.replace("lib","").replace(".so","")
                            }
                        }
                    } // switch
                } // switch item
            ...
            LabelHeadline {
                leftPadding: 10
                text: qsTr("Prepare the Repository Data")
            }
            RowLayout {
                ButtonFlat {
                    text: qsTr("prepare")
                    ...
                    onClicked: {
                        dataUtil.prepareRepository()
                    }
                }
            }
            // "/storage/emulated/0/data/msolanogadea/c2gDiCoTAE_x/data/repository/"
            // "/storage/emulated/0/data/msolanogadea/c2gDiCoTAE_x/data/repository/creatorImages/"
            RowLayout {
                Layout.leftMargin: 16
                LabelBodySecondary {
                    anchors.verticalCenter: parent.verticalCenter
            ...
            RowLayout {
                ...
                LabelBodySecondary {
                    ...
                    text: qsTr("Repository data stored at:\n/storage/emulated/0/data/msolanogadea/c2gDiCoTAE_x/data/repository/")
                    Layout.preferredWidth: 1
                    font.italic: true
                }
            } // row
